...
class ECG:
	...
	def DimensionalReduciton(self,test_final):
		...
		pca_loaded_model = joblib.load('D:/Projects/MLs/Cardiovascular/model_pkl/PCA_ECG (1).pkl')
	...
	def ModelLoad_predict(self,final_df):
		...
		"""
		loaded_model = joblib.load('D:/Projects/MLs/Cardiovascular/model_pkl/Heart_Disease_Prediction_using_ECG (4).pkl')
